...
export default function Home() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[600px] sm:min-h-[640px] md:h-screen flex items-center pt-24 pb-12 sm:pt-28 sm:pb-16 md:py-0">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 w-full">
          <div className="max-w-2xl bg-[#111111]/95 p-6 sm:p-8 md:p-12 backdrop-blur-sm border-l-4 sm:border-l-8 border-orange-500 shadow-2xl rounded-r-2xl">
            <span className="text-orange-400 font-semibold text-xs sm:text-sm uppercase tracking-[0.2em] mb-3 sm:mb-4 block">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 sm:flex-wrap">
              <Link href="/services" className="bg-orange-600 text-white font-semibold text-sm px-6 sm:px-8 py-3 sm:py-4 rounded uppercase hover:bg-orange-700 transition text-center">
                Our Services
              </Link>
              <Link href="/about" className="border-2 border-orange-500 text-orange-400 font-semibold text-sm px-6 sm:px-8 py-3 sm:py-4 rounded uppercase hover:bg-orange-500/10 transition text-center">
                View Portfolio
              </Link>
            </div>
          </div>
      ...
      {/* Projects Showcase */}
      <section className="py-20 max-w-7xl mx-auto px-8"><div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-12"><div><h2 className="text-3xl font-bold">Project Portfolio</h2><p className="text-gray-400 mt-2">A testament to our commitment to excellence.</p></div><Link href="/services" className="text-orange-400 font-semibold uppercase flex items-center gap-2 hover:gap-3 transition self-start sm:self-auto">View All Projects <span className="material-symbols-outlined">grid_view</span></Link></div>
      ...
      <section className="max-w-7xl mx-auto px-8 mb-20">
        <div className="bg-orange-700 rounded-xl p-12 md:p-20 text-white flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden">
          <div><h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">Ready to build your vision?</h2><p className="text-base sm:text-lg opacity-90">Contact our engineering team today for a comprehensive consultation.</p></div>
          <Link href="/contact" className="bg-white text-orange-800 font-bold text-sm px-8 sm:px-10 py-4 sm:py-5 rounded uppercase shadow-lg hover:bg-gray-100 transition text-center whitespace-nowrap">Start Your Project</Link>
        </div>
      </section>
