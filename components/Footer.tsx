  ...
  return (
    <footer className="w-full py-16 mt-20 bg-[#0a0a0a] border-t border-[#2c2c2c]">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-8 max-w-7xl mx-auto text-center md:text-left">
        <div>
          <span className="text-base font-bold text-white block mb-6">APPEXE DEVELOPMENTS LTD</span>
          <p className="text-sm text-gray-400 max-w-xs mx-auto md:mx-0">
            Your premier partner in structural engineering and premium property development. Registered in England & Wales.
          </p>
        </div>
        <div className="space-y-4">
          <span className="font-semibold text-sm uppercase text-gray-300">Headquarters</span>
          <p className="text-sm text-gray-400 leading-relaxed">
            FLAT 1, 118 GREENGATES STREET<br />STOKE-ON-TRENT, ST6 6DE
          </p>
        </div>
        <div className="space-y-4">
          <span className="font-semibold text-sm uppercase text-gray-300">Contact</span>
          <a
      ...
      <div className="max-w-7xl mx-auto px-8 mt-16 pt-8 border-t border-[#2c2c2c] text-center">
        <p className="text-sm text-gray-500">© 2025 APPEXE DEVELOPMENTS LTD. All rights reserved.</p>
      </div>
    </footer>
  );
}